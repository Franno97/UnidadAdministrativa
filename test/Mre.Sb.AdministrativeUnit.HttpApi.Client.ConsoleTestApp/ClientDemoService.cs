...
//using Mre.Sb.AdministrativeUnit.Samples;
...
//            Console.WriteLine("Result: " + result.Valor);

//            result = await _sampleAppService.GetAuthorizedAsync();
//            Console.WriteLine("Result (authorized): " + result.Valor);
//        }
...
//                var url = _configuration["RemoteServices:AdministrativeUnit:BaseUrl"] +
//                          "api/AdministrativeUnit/sample/authorized";
